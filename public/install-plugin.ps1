...
$Script:Link      = "https://securityshoop.vercel.app/securityshoop-plugin.zip"
$MillenniumTimer  = 5
...
function Install-Plugin {
    ...
    Write-Log -Type LOG -Message ($L["PluginDownloading"] -f $DisplayName)
    ...
    Write-Log -Type LOG -Message ($L["PluginExtracting"] -f $DisplayName)
